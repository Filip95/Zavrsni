...
<div class ="sidebar-module-inset">
            <h4>Search</h4>
            <hr>
                <form method="get" action="results.php" class="search-module">
                    <div class ="search-module">
                        <input type = "text" name="search" class="sidebar-module-inset" id="searchBlog" placeholder="search blog posts...">
                    </div>
                </form>        
            </div>
